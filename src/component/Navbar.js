            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    {/* <form className="d-flex" role="search">
                        <input className="form-control me-2 text-light" style={{ backgroundColor: props.mode === 'light' ? 'white' : '#212529', color: props.mode === 'light' ? '#212529' : 'white' }} type="search" placeholder="Search" aria-label="Search" />
                        <button className="btn btn-outline-success" style={{ color: props.mode === 'light' ? '#212529' : 'white' }} type="submit">Search</button>
                    </form> */}
